...
void setup()
{
  ...
  initRM3100(); //Initialize BMP Sensor
...
void ParseBMP()
{
  ...
  if (altCounter == 4){LowPower(); preAlt = alt; altCounter = 0;}
  else { altCounter++;}
...
bool LowPower()
{
  if (alt - preAlt > 5) //Check if the speed of the cansat is decendimg more that 5 meters
  {
    extended = true;
